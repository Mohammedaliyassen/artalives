...
//   useEffect(() => {
//     fetch("https://api.artalives.com/api/logo-designs?populate=*")
//       .then((res) => res.json())
//       .then((data) => {
//         setLogo(data.data);
//       });
...
//   useEffect(() => {
//     fetch("https://api.artalives.com/api/animations?populate=*")
//       .then((res) => res.json())
//       .then((data) => {
//         setMotian(data.data);
//       });
...
//   useEffect(() => {
//     fetch("https://api.artalives.com/api/visual-identities?populate=*")
//       .then((res) => res.json())
//       .then((data) => {
//         setVisual(data.data);
//       });
...
//   useEffect(() => {
//     fetch("https://api.artalives.com/api/social-medias?populate=*")
//       .then((res) => res.json())
//       .then((data) => {
//         setSocial(data.data);
//       });
